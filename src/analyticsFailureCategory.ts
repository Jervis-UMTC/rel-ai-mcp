...
function failureCategoryFromCode(value: unknown): AnalyticsFailureCategory {
...
function normalizeFailureCategory(value: unknown): AnalyticsFailureCategory {
  ...
  return ANALYTICS_FAILURE_CATEGORY_SET.has(category) ? category as AnalyticsFailureCategory : 'runtime';
}
