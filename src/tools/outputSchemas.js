...
const TOOL_FIELDS = Object.freeze({
  ...
  [OP.BROWSER]: ['ok', 'workspace', 'work_id', 'action', 'sessionId', 'tabId', 'activeTabId', 'activeSessionCount', 'sessions', 'tabs', 'count', 'url', 'statusCode', 'title', 'viewport', 'browserEngine', 'browserProduct', 'profile', 'createdAt', 'snapshot', 'truncated', 'interaction', 'target', 'image', 'path', 'bytes', 'sha256', 'suggestedFilename', 'changed', 'status', 'error'],
  [OP.DESKTOP]: ['ok', 'workspace', 'work_id', 'action', 'platform', 'path', 'kind', 'uri', 'application', 'text', 'textLength', 'message', 'error'],
  [OP.COMPUTER]: ['ok', 'workspace', 'work_id', 'action', 'platform', 'enabled', 'available', 'engine', 'displayId', 'screen', 'display', 'displays', 'count', 'image', 'executed', 'x', 'y', 'toX', 'toY', 'direction', 'distance', 'textLength', 'key', 'keys', 'message', 'error'],
