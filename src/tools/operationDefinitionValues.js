...
const OPERATION_DEFINITION_VALUES = [
  ...
  },
  {
    ...
    description: "Control the user-authorized local desktop through the Midscene computer runtime. Coordinates are local to the selected display; when displayId is omitted, Midscene targets the primary display. Status is available while control is disabled; every other action requires the explicit Computer control setting.",
    inputSchema: {"type":"object","properties":{"workspace":{"type":"string"},"action":{"type":"string","enum":["status","displays","screenshot","move","click","double_click","right_click","drag","scroll","type","key","hotkey"]},"displayId":{"type":"string","minLength":1,"maxLength":200},"x":{"type":"number","minimum":0,"maximum":100000},"y":{"type":"number","minimum":0,"maximum":100000},"toX":{"type":"number","minimum":0,"maximum":100000},"toY":{"type":"number","minimum":0,"maximum":100000},"direction":{"type":"string","enum":["up","down","left","right"]},"distance":{"type":"number","minimum":1,"maximum":100000},"text":{"type":"string","minLength":1,"maxLength":65536},"key":{"type":"string","minLength":1,"maxLength":100},"keys":{"type":"array","items":{"type":"string","minLength":1,"maxLength":100},"minItems":2,"maxItems":8}},"required":["workspace","action"],"additionalProperties":false},
